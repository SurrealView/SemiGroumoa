...
<% ManagerVO manager = (ManagerVO) request.getAttribute("manager"); 
   ManagerVO managerD = (ManagerVO) request.getAttribute("managerD");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	<div id="manager">
		<label style="font-weight:bold; position:absolute; top: 20px; left: 20px; font-size:20px;">회원 정보</label>
   		...
   		<div class="num" id="list1"><label>이름  </label>&nbsp;&nbsp;&nbsp;
   		<input type="text"  class ="form-control" id="fname" name="fname" value="<%= manager.getManagerName()%>"></div>
   		<div class="num" id="list2"><label>계정  </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
   		<input type="text" class ="form-control" id="fname" name="fname" value="<%= manager.getManagerId() %>"></div>
   		<div class="num" id="list3"><label>비밀번호</label>&nbsp;
   		<input type="text" class ="form-control" id="fname" name="fname" value="<%= manager.getManagerPwd() %>" style ="width:700px;">
   		<br>(변경시에만 입력)</div>
	...
	<div id="activity">
		...
		<input type="text" id="detail" value=""></div>
    	...
    	<div id="list2">
  	    ...
  	    <input type="text" id="detail" value=<%= manager.getNoticeCode() %>></div>
