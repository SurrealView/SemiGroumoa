...
/**
 * Servlet implementation class ManagerGroupMemberServlet
 */
@WebServlet("/managerGroupMember.mn")
public class ManagerGroupMemberServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManagerGroupMemberServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//전체 목록 갯수를 조회
		int listCount = new MemberService().getGroupMemberCount();
