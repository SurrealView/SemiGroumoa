...
/**
 * Servlet implementation class ManagerGroupLeaderServlet
 */
@WebServlet("/managerGroupLeader.mn")
public class ManagerGroupLeaderServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ManagerGroupLeaderServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//전체 목록 갯수를 조회
		int listCount = new MemberService().getGroupLeaderCount();
		...
		ArrayList<MemberVO> list = new MemberService().selectGroupLeaderList(pi);
