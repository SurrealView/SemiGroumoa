...
/**
 * Servlet implementation class SelectBoardListAsLeaderServlet
 */
@WebServlet("/selectListAsLeader.bo")
public class SelectBoardListAsLeaderServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectBoardListAsLeaderServlet() {
        super();
