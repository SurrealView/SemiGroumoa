...
/**
 * Servlet implementation class SearchBoardByWriterServlet
 */
@WebServlet("/searchByWriter.bo")
public class SearchBoardByWriterServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchBoardByWriterServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//전체 목록 갯수를 조회
		int listCount = new BoardService().getSearchByWriterResultListCount(search, groupCode);
		...
		ArrayList<BoardVO> list = new BoardService().selectSearchByWriterResultList(pi, groupCode, search);
