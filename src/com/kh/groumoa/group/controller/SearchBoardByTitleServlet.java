...
/**
 * Servlet implementation class SearchBoardByTitleServlet
 */
@WebServlet("/searchByTitle.bo")
public class SearchBoardByTitleServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SearchBoardByTitleServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//전체 목록 갯수를 조회
		int listCount = new BoardService().getSearchByTitleResultListCount(search, groupCode);
		...
		ArrayList<BoardVO> list = new BoardService().selectSearchByTitleResultList(pi, groupCode, search);
